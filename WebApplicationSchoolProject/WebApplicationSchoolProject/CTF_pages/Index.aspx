<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="WebApplicationSchoolProject.CTF_pages.Index" %>
<!DOCTYPE html>
<html lang="en">
                ...
                <nav class="navbar px-0 navbar-expand-lg navbar-dark">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        ...
                        <div class="navbar-nav ml-auto">
                            <a href="Index.aspx" class="p-3 text-decoration-none text-white bold">Home</a>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4">
                        ...
                        <button class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" onclick="(function(){window.location.href='Login.aspx'})();">
                            <h4>Login</h4>
                        </button>
                    </div>
                </div>
