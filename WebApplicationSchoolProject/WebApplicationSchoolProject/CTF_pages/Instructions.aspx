<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Instructions.aspx.cs" Inherits="WebApplicationSchoolProject.CTF_pages.Instructions" %>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <form id="instructions" runat="server">
                    <div class="navbar-nav ml-auto">
                        <a href="Instructions.aspx" class="p-3 text-decoration-none text-white bold">Instructions</a>
                        <a href="Quests.aspx" class="p-3 text-decoration-none text-light bold">Challenges</a>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row justify-content-center  hackerFont ">
                        <div class="col-md-10">
                            ...
                            <ul>
                                <li>Each question has some points to it depending upon the difficulty. In the future taking a hint will deduce 10% of the points associated with the question.</li>
                                <li>There is no particular order of solving the questions.</li>
                                <li>Flags found are of the format <span class="vim-caret">My_ctf{some_text}.</span> Some of the files may contain just the inner text within the brackets. Make sure you submit it in the format specified. Flag text is not
                                    case sensitive.</li>
                            ...
                            <div class="row text-center pt-5">
                                <div class="col-xl-12">
                                    <button class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" onclick="(function(){window.location.href='Quests.aspx'})();">
